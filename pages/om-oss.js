  ...
  return (
    <>
      ...
      <main style={{ maxWidth:760, margin:'0 auto', padding:'56px 20px', lineHeight:1.8, color:'#374151', fontFamily:'Inter,sans-serif' }}>
        ...
        <p style={{ fontSize:17, color:'#64748b', marginBottom:40 }}>Hälsokostkollen drivs av Qubeit — ett svenskt bolag som bygger oberoende jämförelsetjänster för svenska konsumenter.</p>
        <h2 style={{ fontSize:22, fontWeight:700, marginBottom:12, color:'#0f172a' }}>Vad vi gör</h2>
        <p style={{ marginBottom:20, fontSize:15 }}>Hälsokostkollen samlar och presenterar information om leverantörer inom hälsa. Vi rangordnar och betygsätter baserat på pris, villkor, kundservice och användarrecensioner. Vår trafik kommer från organisk söktrafik via Google och Bing.</p>
